...
| `Spinner`                                                                                    | нет в макете; заглушку загрузки приложение рисует у себя                                                                                                                                             |
| `StarRating`                                                                                 | `StarRating`                                                                                                                                                                                         |
| `ErrorBoundary`                                                                              | нет; ошибку действия показывает `useToast`, заглушку секции приложение рисует у себя                                                                                                                 |
| `cn`                                                                                         | `cn`                                                                                                                                                                                                 |
