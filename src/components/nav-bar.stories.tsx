    ...
    <div className="flex flex-col gap-(--spacing-gap-24)">
      <section className="flex flex-col gap-(--spacing-gap-8)">
        ...
        <p className="max-w-[560px] text-[10px] leading-(--typography-line-height-12) text-(color:--text-tertiary)">
          Вес глифа в макете меняется вместе с состоянием: light у неактивной вкладки и наведения,
          bold у активной. Колонка Hover нарисована ролью, а не настоящим наведением: статикой
          псевдокласс не показать. Роли берутся из того же модуля, что и в компоненте.
        </p>
